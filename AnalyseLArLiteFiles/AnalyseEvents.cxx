...
namespace larlite {
    ...
    //....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
    bool AnalyseEvents::SetArgs ( TString fworker, Int_t fdebug, Int_t fNMaxEntries,
                                 bool fDoExtractTracks, TString fFeaturesFileName,
                                 bool fDoCreateEvdImages, TString fimages_path ){
        SetWorker       (fworker);
        SetDebug        (fdebug);
        SetDoExtractInfo(fDoExtractTracks);
        SetFeaturesFName(fFeaturesFileName);
        SetDoEvdImages  (fDoCreateEvdImages);
