...
Operation   = "ADC around corners" # "Draw" # "ADC around corners" #
Var         = sys.argv[1] if len(sys.argv)>1 else "straight_vs_segmented_track_length"
cut         = ROOT.TCut()
Path        = "/Users/erezcohen/Desktop/uBoone/AnaFiles"
Filename    = "Ana_larlite_95_wire_pandoraNu_543_evts.root"#"Ana_larlite_pandoraNu_95_AllGoodRuns_543_events.root"
...
if Operation == "Draw":
    ...
    gen_plot.plot(ana,"BDTcandidates",plot_args)
# ------------------------------------------------------------------ #
